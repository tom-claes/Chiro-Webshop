        ...
        <div class="flex flex-col flex-shrink-0 w-full">
          ...
          <nav>
            <div class="flex-grow md:block md:overflow-y-auto overflow-x-hidden">
              ...
              <a class="flex items-center px-4 py-3 hover:bg-gray-800 focus:bg-gray-800 hover:text-gray-400 focus:outline-none focus:ring" {{ request()->is('admin/stock*') ? 'bg-gray-800' : '' }}" href="{{ route('admin.stock') }}">
                <svg class="w-5 h-5 fill-current" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 24 24">
